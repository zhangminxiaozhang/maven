...
public class MyMqttService extends Service {
    ...
    public String HOST = "tcp://3z0d0gb.mqtt.iot.gz.baidubce.com:1883";//服务器地址（协议+地址+端口号）
    public String USERNAME = "3z0d0gb/iot";//用户名
    public String PASSWORD = "x2oiUhGsE40Az4aH";//密码
    public static String PUBLISH_TOPIC  = "tourist_enter";//发布主题
    public static String RESPONSE_TOPIC = "message_arrived";//响应主题
    // @RequiresApi(api = 26)
    //public String CLIENTID = Build.VERSION.SDK_INT >= Build.VERSION_CODES.O ? Build.getSerial() : Build.SERIAL;//客户端ID，一般以客户端唯一标识符表示，这里用设备序列号表示
